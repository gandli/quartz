...
| 软件                                                                          | 平台                  |
| --------------------------------------------------------------------------- | ------------------- |
| [pot-desktop](https://github.com/pot-app/pot-desktop)                       | win、macOS           |
| [Easydict](https://github.com/tisfeng/Easydict)                             | macOS               |
| [openai-translator](https://github.com/openai-translator/openai-translator) | Windows、macOS、Linux |
