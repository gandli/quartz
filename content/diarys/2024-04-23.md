...
1. [penetration-suite-toolkit](https://github.com/makoto56/penetration-suite-toolkit)基于 Windows10 Workstation 22H2 x64 原版镜像制作(不适用于ARM设备)，帮助渗透新手快速搭建工作环境。
	- 建议运行环境： VMware：16.x(建议视情分配图形内存) / 运行内存：8G / 固态硬盘：300G
2. [Windows11 Penetration Suite Toolkit](https://github.com/arch3rPro/Pentest-Windows#windows11-penetration-suite-toolkit-)一个开箱即用的 Windows11 渗透测试环境
