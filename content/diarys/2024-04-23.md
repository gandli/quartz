...
1. [penetration-suite-toolkit](https://github.com/makoto56/penetration-suite-toolkit)基于 Windows10 Workstation 22H2 x64 原版镜像制作(不适用于ARM设备)
2. [Windows11 Penetration Suite Toolkit](https://github.com/arch3rPro/Pentest-Windows#windows11-penetration-suite-toolkit-)一个开箱即用的windows渗透测试环境
